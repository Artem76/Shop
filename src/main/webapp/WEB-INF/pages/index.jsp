        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="/" class="active">Ãëàâíàÿ</a></li>
                            <li><a href="/contact">Êîíòàêòû</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <input type="submit" value="Ïðèìåíèòü ôèëüòð"
                                               style="background-color: orange; text-align: center; border: none ">
                                        <%--<a id="filter" class="btn btn-default check_out" href="/index?type=${t}&numberOfWires=456&area=789">Ïðèìåíèòü ôèëüòð</a>--%>
                                    </h4>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="/photo/${product.photo.id}" <%--style="height: 150px; width: 150px"--%>
                                             alt=""/>
                                        <h2 data-reveal-id="myModal">${product.price} ãðí.</h2>
                                        <p>${product.type}${product.numberOfWires}x${product.area}</p>
                                            <%--<a href="#" class="btn btn-default add-to-cart"><i
                                                    class="fa fa-shopping-cart"></i>Add to cart</a>--%>
                                    </div>
...
<script>
    $("#product_menu").click(function (event) {
        alert("Äëÿ ñîâåðøåíèÿ ïîêóïîê âîéäèòå ïîä ñâîèì ëîãèíîì!");
    });
