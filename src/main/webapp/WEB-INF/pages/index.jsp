                ...
                <%--<div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="https://www.facebook.com/artem.khirgii"><i class="fa fa-facebook"></i></a></li>
                        </ul>
                    </div>
                </div>--%>
            </div>
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="type" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul>
                                        <li><input type="radio" name="type_cable" value="All" checked><a <%--href=""--%>> Все типы</a></li>
                                        <c:forEach items="${types}" var="type">
                                        <li><input type="radio" name="type_cable" value="${type}"><a <%--href=""--%>> ${type}</a></li>
                                        </c:forEach>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="numberOfWires" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul>
                                        <li><input type="radio" name="numberOfWires_cable" value="0" checked><a <%--href=""--%>> Все типы</a></li>
                                        <c:forEach items="${numberOfWireses}" var="numberOfWires">
                                            <li><input type="radio" name="numberOfWires_cable" value="${numberOfWires}"><a <%--href=""--%>> ${numberOfWires}</a></li>
                                        </c:forEach>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="area" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <ul>
                                        <li><input type="radio" name="area_cable" value="0.0" checked><a <%--href=""--%>> Все типы</a></li>
                                        <c:forEach items="${areas}" var="area">
                                            <li><input type="radio" name="area_cable" value="${area}"><a <%--href=""--%>> ${area}</a></li>
                                        </c:forEach>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <input type="submit" value="Применить фильтр" style="background-color: orange; text-align: center; border: none ">
...
<script>
   ...
   /* var t = $('input[name=type_cable]:checked').val();
    var n = $('input[type=radio][name=numberOfWires_cable][value=null]')
            .prop('checked', true).val();
    var a = $('input[type=radio][name=area_cable][value=null]')
            .prop('checked', true).val();*/
