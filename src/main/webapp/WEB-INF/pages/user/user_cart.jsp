            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a><i class="fa fa-user"></i> ${login}</a></li>
                            <li><a href="/shop"><i class="fa fa-shopping-cart"></i> Ìàãàçèí</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="/shop">Ãëàâíàÿ</a></li>
                            <li class="dropdown"><a <%--href="#"--%>>Çàêàçû<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="/user_cart" class="active">Êîðçèíà</a></li>
...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            ...
            <h2 style="color: orange; text-align: center">Êîðçèíà.</h2>
        </div>
    </div>
</section>
<section id="cart_items">
        ...
        <div class="container">
            <div class="col-sm-6">
                <div class="total_area">
                    <form action="/user_box_order" method="post">
                        <ul>
                            <textarea name="description" placeholder="Ïîÿñíåíèÿ ê çàêàçó." rows="16"></textarea>
                            <li>Îáùàÿ ñòîèìîñòü <span>${sum} ãðí.</span></li>
                            <input type="submit" id="order" class="btn btn-default check_out" value="Çàêàçàòü">
                        </ul>
                    </form>
                </div>
            </div>
...
<script>
    $("#order").click(function (event) {
        alert("Çàêàç îòïðàâëåí â îáðàáîòêó!");
    });
    $("#logout").click(function (event) {
