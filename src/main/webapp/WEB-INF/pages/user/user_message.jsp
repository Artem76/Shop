                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li><a href="/user_message" class="active">Îòçûâû è ïðåäëîæåíèÿ</a></li>
...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            <h2 style="color: orange; text-align: center">Îòçûâû è ïðåäëîæåíèÿ</h2>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="total_area">
                    <form action="/user_message_post" method="post">
                        <ul style="margin-left: -2%">
                            <label style="margin: 0 auto">Íîâîå ñîîáùåíèå îò êëèåíòà ${login}:</label>
                            <textarea name="user_messages" placeholder="Îòçûâ èëè ïðåäëîæåíèå." rows="3"></textarea>
                            <input type="submit" id="message" class="btn btn-default check_out" value="Îòïðàâèòü">
                        </ul>
                    </form>
                </div>
            </div>
...
<section style="margin-top: 20px">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center">Âñå ñîîáùåíèÿ</h2>
                    <c:forEach items="${messages}" var="message">
                        <div class="col-sm-12">
                            <div class="total_area">
                                <ul style="margin-left: -3%">
                                    <label style="margin: 0 auto">Ñîîáùåíèå îò êëèåíòà ${message.user.login}</label>
                                    <label style="margin: 0 auto">GMT ${message.date}</label>
                                    <li>${message.message}</li>
                                </ul>
                            </div>
