                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a>Ïðîäóêöèÿ<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="/manager_product_all" class="active">Âåñü êàáåëü</a></li>
...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            ...
            <c:if test="${not empty del_error}">
                <h2 style="color: red; text-align: center">Óäàëåíèå íå âîçìîæíî (êàáåëü â çàêàçå)!</h2>
            </c:if>
            <c:if test="${not empty update}">
                <h2 style="color: greenyellow; text-align: center">Äàííûå óñïåøíî èçìåíåíû</h2>
            </c:if>
            <h2 style="color: orange; text-align: center">Âåñü êàáåëü</h2>
        </div>
    </div>
</section>
