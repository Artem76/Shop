                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a>Ïðîäóêöèÿ<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    ...
                                    <li><a href="/manager_product_add" class="active">Äîáàâèòü êàáåëü</a></li>
...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            ...
            <c:if test="${not empty photo_error}">
                <h2 style="color: red; text-align: center">Íå âûáðàíî ôîòî</h2>
            </c:if>
            <c:if test="${not empty type_erorr}">
                <h2 style="color: red; text-align: center">Òàêîé êàáåëü óæå ñóùåñòâóåò</h2>
            </c:if>
            <c:if test="${not empty add}">
                <h2 style="color: greenyellow; text-align: center">Êàáåëü óñïåøíî äîáàâëåí</h2>
            </c:if>
            <h2 style="color: orange; text-align: center">Äîáàâëåíèå êàáåëÿ</h2>
        </div>
    </div>
</section>
    ...
    <section style="margin-top: 30px">
        <div class="container">
            <div class="row">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            <section>
                                <div class="container">
                                    <h4 class="panel-title">
                                        <p>Òèï êàáåëÿ</p>
                                        <input type="text" name="type_cable" placeholder="Òèï">
                                        <p></p>
                                        <p>Êîëè÷åñòâî æèë êàáåëÿ</p>
                                        <input type="text" name="numberOfWires_cable" placeholder="Êîëè÷åñòâî æèë">
                                        <p></p>
                                        <p>Ïëîùàäü ïîïåðå÷íîãî ñå÷åíèÿ æèëû</p>
                                        <input type="text" name="area_cable" placeholder="Ñå÷åíèå">
                                        <p></p>
                                        <p>Ñòîèìîñòü êàáåëÿ, ãðí.</p>
                                        <input type="text" name="price_cable" placeholder="Öåíà">
                                        <p></p>
                                        <p>Êîëè÷åñòâî êàáåëÿ, ì.</p>
                                        <input type="text" name="number_cable" placeholder="Êîëè÷åñòâî">
                                        <p></p>
                                        <p>Îïèñàíèå êàáåëÿ</p>
                                        <input type="text" name="description_cable" placeholder="Îïèñàíèå">
                                        <p></p>
                                    </h4>
                                </div>
                            </section>
                ...
                <div class="col-sm-8 padding-right">
                    <div class="features_items"><!--features_items-->
                        <h2 class="title text-center">Ôîòî äëÿ êàáåëÿ</h2>
                        <div class="col-sm-2">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 ">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="/contact">Àðòåì Õèðãèé </a></li>
                            <li><a href="/contact"><i class="fa fa-phone"></i> +38(097)946 89 25</a></li>
                            <li><a href="mailto:cmua76@outlook.com"><i class="fa fa-envelope"></i>
                                cmua76@outlook.com</a></li>
                            <li><a href="https://www.facebook.com/artem.khirgii"><i class="fa fa-facebook"></i>
