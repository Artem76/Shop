...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            ...
            <h2 style="color: orange; text-align: center">Çàêàç îò GMT ${date}.</h2>
            <h2 style="color: orange; text-align: center">Êëèåíò
                <a href="/manager_client?id_client=${id_client}" style="color: orange; text-decoration: underline">${login_client}</a>
                . Ìåíåäæåð
                <c:if test="${not empty login_manager}">
                    ${login_manager}
...
<section id="cart_items">
    <div class="container">
        ...
        <table class="table table-condensed">
            <thead>
            <tr class="cart_menu">
                <td class="image">Êàáåëü</td>
                <td class="description"></td>
                <td class="price">Öåíà çà åäèíèöó, ãðí.</td>
                <td class="quantity">Êîëè÷åñòâî, ì.</td>
                <c:if test="${not empty edit}">
                    <td class="description"></td>
                </c:if>
                <td class="total">Ñòîèìîñòü, ãðí.</td>
                <c:if test="${not empty edit}">
                    <td style="width: 38px"></td>
                </c:if>
            </tr>
                ...
                <tr>
                    ...
                    <c:if test="${not empty edit}">
                        <form action="/manager_box_update_ord?ord_id=${ord.id}&box_id=${box_id}" method="post">
                            ...
                            <td>
                                <input type="submit" class="btn btn-default update" value="Îáíîâèòü"
                                       style="margin: 0 auto">
                            </td>
                        </form>
                    </c:if>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="total_area">
                    <ul>
                        <label style="margin: 0 auto">Ñîîáùåíèå:</label>
                        <li>${description}</li>
                        <li>Îáùàÿ ñòîèìîñòü <span>${sum} ãðí.</span></li>
                        <c:if test="${not empty edit}">
                            <c:if test="${empty complete}">
                                <a class="btn btn-default check_out"
                                   href="/manager_box_complete?box_id=${box_id}">Âûïîëíèòü</a>
                            </c:if>
                            <c:if test="${not empty complete}">
                                <a class="btn btn-default check_out" style="background-color: red">Íåäîñòàòî÷íî
                                    êàáåëÿ</a>
                            </c:if>
                        </c:if>
                        <c:if test="${not empty closed}">
                            <a class="btn btn-default check_out" style="background-color: red">Çàêàç óæå âûïîëíåí</a>
                        </c:if>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="total_area">
                    <ul>
                        <label style="margin: 0 auto">Òåëåôîí:</label>
                        <li style="margin: 0 auto">${phone}</li>
                        <label style="margin: 0 auto">Email:</label>
                        <li style="margin: 0 auto">${email}</li>
                        <label style="margin: 0 auto">Àäðåñ äîñòàâêè:</label>
                        <li style="margin: 0 auto">${address}</li>
                    </ul>
                </div>
            </div>
