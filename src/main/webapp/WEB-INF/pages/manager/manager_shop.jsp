                    ...
                    <tr style="text-align: center">
                        ...
                        <td>
                            <a class="btn btn-default update" style="margin: 0 auto"
                               href="/manager_take_box?box_id=${box.id}">Принять</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="/shop" class="active">Íîâûå çàêàçû</a></li>
...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            <h2 style="color: orange;text-align: center">Íîâûå çàêàçû.</h2>
        </div>
    </div>
</section>
            ...
            <table class="table table-condensed">
                ...
                <c:forEach items="${boxes}" var="box">
                    <tr style="text-align: center">
                        ...
                        <td>
                            <a class="btn btn-default update" style="margin: 0 auto"
                               href="/manager_take_box?box_id=${box.id}">Ïðèíÿòü</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
