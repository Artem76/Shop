                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a <%--href="#"--%>>Ñâîè çàêàçû<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="/manager_their_orders_work" class="active">Â ðàáîòå</a></li>
...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            <h2 style="color: orange; text-align: center">Ñâîè çàêàçû íàõîäÿùèåñÿ â ðàáîòå.</h2>
        </div>
    </div>
</section>
                ...
                <c:forEach items="${boxes}" var="box">
                    <tr style="text-align: center">
                        ...
                        <td>
                            ...
                            <a class="btn btn-default update" style="margin: 0 auto"
                               href="/manager_out_box?box_id=${box.id}">Îòêàçàòüñÿ</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
