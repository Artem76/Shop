                ...
                <div class="col-sm-12">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li><a href="/manager_contact" class="active">Êîíòàêòû</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<div id="contact-page" class="container" style="margin-top: 40px">
    <div class="bg">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="title text-center">Ðàçðàáîò÷èê</h2>
            </div>
        </div>
        <section id="slider"><!--slider-->
            <div class="container">
                    ...
                    <div class="col-sm-12">
                        <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div class="col-sm-6 text-center">
                                        <h2 style="margin-top: 60px">Îáó÷àåìîñòü</h2>
                                        <p>Óìåþ áûñòðî è ýôôåêòèâíî ó÷èòüñÿ. </p>
                                    </div>
                                    <div class="col-sm-6">
                                        <img src="images/study.png" class="girl img-responsive" alt=""/>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="col-sm-6 text-center">
                                        <h2 style="margin-top: 60px">Ñòðåññîóñòîé÷èâîñòü</h2>
                                        <p>Áîãàòûé îïûò ðàáîòû ñ ðàçíûìè ëþäüìè.</p>
                                    </div>
                                    <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="contact-info" style="text-align: center">
                    <h2 class="title text-center">Ôîòî</h2>
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <img src="images/myPhoto1.png" alt=""
            ...
            <div class="col-sm-8">
                <div class="contact-form">
                    <h2 class="title text-center">Êîíòàêòû</h2>
                    <div class="status alert alert-success" style="display: none"></div>
                    <div class="form-group col-md-12">
                        <a type="text" class="form-control" required="required"
                           style="height: auto; margin-top: 10px">Àðòåì Ãåííàäüåâè÷
                            Õèðãèé</a>
                        <a type="text" class="form-control" required="required"
                           style="height: auto; margin-top: 10px"><i
                                class="fa fa-phone"></i> +38(097)946 89 25</a>
