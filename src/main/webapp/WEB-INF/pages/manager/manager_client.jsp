...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            <h2 style="color: orange; text-align: center">Âñå çàêàçû êëèåíòà ${login_client}.</h2>
        </div>
    </div>
</section>
        ...
        <div class="table-responsive cart_info">
            <table class="table table-condensed">
                ...
                <tr class="cart_menu" style="text-align: center">
                    ...
                    <td class="description">Ìåíåäæåð</td>
                    <td class="description">Ñîñòîÿíèå</td>
                    <td class="description"></td>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${boxes}" var="box">
                    <tr style="text-align: center">
                        ...
                        <td class="cart_total_price">
                            <c:if test="${box.status == 1}">
                                <p style="margin: 0 auto">Â ðàáîòå</p>
                            </c:if>
                            <c:if test="${box.status == 2}">
                                <p style="margin: 0 auto">Âûïîëíåí</p>
                            </c:if>
                        </td>
                        <td>
                            <a class="btn btn-default update" style="margin: 0 auto"
