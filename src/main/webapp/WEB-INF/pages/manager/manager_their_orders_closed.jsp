                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a <%--href="#"--%>>Свои заказы<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    ...
                                    <li><a href="/manager_their_orders_closed" class="active">Выполненные</a></li>
                                </ul>
                            </li>
                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a <%--href="#"--%>>Ñâîè çàêàçû<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    ...
                                    <li><a href="/manager_their_orders_closed" class="active">Âûïîëíåííûå</a></li>
                                </ul>
                            </li>
...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            <h2 style="color: orange; text-align: center">Ñâîè âûïîëíåííûå çàêàçû.</h2>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="table-responsive cart_info">
            <table class="table table-condensed">
                <thead>
                <tr class="cart_menu" style="text-align: center">
                    <td class="description">Âðåìÿ</td>
                    <td class="price">Êëèåíò</td>
                    <td class="description"></td>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${boxes}" var="box">
                    <tr style="text-align: center">
                        ...
                        <td>
                            <a class="btn btn-default update" style="margin: 0 auto"
                               href="/manager_work_box?box_id=${box.id}">Îòêðûòü</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
