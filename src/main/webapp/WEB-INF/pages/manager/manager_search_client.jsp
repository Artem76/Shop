                ...
                <div class="col-sm-12">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a <%--href="#"--%>>Ñâîè çàêàçû<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="/manager_their_orders_work">Â ðàáîòå</a></li>
                                    <li><a href="/manager_their_orders_closed">Âûïîëíåííûå</a></li>
                                </ul>
                            </li>
                            <li class="dropdown"><a <%--href="#"--%>>Âñå çàêàçû<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="/manager_all_orders_work">Â ðàáîòå</a></li>
                                    <li><a href="/manager_all_orders_closed">Âûïîëíåííûå</a></li>
                                </ul>
                            </li>
                            <li><a href="/manager_search_client" class="active">Ïîèñê êëèåíòà</a></li>
                            <li class="dropdown"><a <%--href="#"--%>>Ïðîäóêöèÿ<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            <h2 style="color: orange; text-align: center">Ïîèñê êëèåíòà.</h2>
            <h3 style="color: orange; text-align: center">Ââåäèòå ÷àñòü ëîãèíà èëè òåëåôîíà êëèåíòà:
                <form class="navbar-form" role="search" action="/manager_search_client_pattern" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control" name="pattern" placeholder="Ïîèñê êëèåíòà">
                    </div>
                    <button type="submit" class="btn btn-default check_out" style="margin: 0 auto">Íàéòè</button>
                </form>
            </h3>
        </div>
    </div>
    ...
    <div class="container">
        <div class="table-responsive cart_info">
            <table class="table table-condensed">
                <thead>
                <tr class="cart_menu" style="text-align: center">
                    <td class="description">Ëîãèí</td>
                    <td class="description">Òåëåôîí</td>
                    <td class="description">Email</td>
                    <td></td>
                </tr>
                </thead>
                ...
                <c:forEach items="${users}" var="user">
                    <tr style="text-align: center">
                        ...
                        <td>
                            <a class="btn btn-default update" style="margin: 0 auto"
                               href="/manager_client?id_client=${user.id}">Îòêðûòü</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
