                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a <%--href="#"--%>>Âñå çàêàçû<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="/manager_all_orders_work" class="active">Â ðàáîòå</a></li>
...
<section id="form" style="margin: 0"><!--form-->
    <div class="container">
        <div class="row">
            <h2 style="color: orange;text-align: center">Âñå çàêàçû íàõîäÿùèåñÿ â ðàáîòå.</h2>
        </div>
    </div>
</section>
